...
extension LessonService {
  ...
  public static let sample1 = LessonService(
    ...
    scheduleType: .fixed,
    availableTimes: [
      TimeByWeekday(weekday: .mon, startTime: HMTime(hour: 9, minute: 0), endTime: HMTime(hour: 18, minute: 0)),
      TimeByWeekday(weekday: .wed, startTime: HMTime(hour: 9, minute: 0), endTime: HMTime(hour: 18, minute: 0)),
    ],
    lessonStyle: .both,
    isAvailableOfflineCounseling: true,
    trialPolicy: .free,
