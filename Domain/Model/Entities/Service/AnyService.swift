...
public struct AnyService: Service {
  ...
  init(_ service: some Service) {
    box = _ServiceBox(service)
  }
  ...
  public var isLiked: Bool { box.isLiked }
...
private class _AbstractServiceBox: Service {
  ...
  var isLiked: Bool { fatalError("Must override") }

  func hash(into _: inout Hasher) {
    fatalError("Must override")
  }

  func isEqual(to _: _AbstractServiceBox) -> Bool {
    fatalError("Must override")
  }

  static func == (_: _AbstractServiceBox, _: _AbstractServiceBox) -> Bool {
    fatalError("Must override")
  }
...
private final class _ServiceBox<Base: Service>: _AbstractServiceBox {
  ...
  override var isLiked: Bool { base.isLiked }
