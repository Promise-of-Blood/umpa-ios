...
private struct ServiceTypeCard: View {
    ...
    private func didTap() {
        withAnimation(.easeInOut) {
            ...
            appState.userData.teacherFinder.isShowedServiceTypeSelectView = true
        }
    }
}
...
private extension ServiceType {
    ...
    var description: String {
        switch self {
        case .lesson:
            return "실력있는 음파 선생님들과의 1:1 맞춤 레슨"
        case .accompanist:
            return "전문 반주자와 함께하는 입시 반주"
        case .scoreCreation:
            return "맞춤형 악보 편곡 및 제작"
        case .mrCreation:
            return "고품질 반주용 음원 제작"
        }
    }
}
