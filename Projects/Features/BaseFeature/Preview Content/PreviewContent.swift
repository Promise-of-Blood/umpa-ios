...
extension AppState {
  @discardableResult
  public static func overrideForPreview() -> AppState {
    let appState = AppState()
    appState.appData.regionList = _regionList()

    Container.shared.appState.register {
      appState
    }
...
private func _regionList() -> [RegionalLocalGovernment: [BasicLocalGovernment]] {
