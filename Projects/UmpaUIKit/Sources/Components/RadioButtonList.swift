...
public protocol RadioButtonItem: Hashable {
  var title: String { get }
}

public struct RadioButtonList<Item: RadioButtonItem>: View {
  ...
  public init(selectedItem: Binding<Item>, itemList: [Item]) {
    _selectedItem = selectedItem
    self.itemList = itemList
  }

  public init(selectedItem: Binding<Item>, itemList: [Item]) where Item == String {
    _selectedItem = selectedItem
    self.itemList = itemList
  }
