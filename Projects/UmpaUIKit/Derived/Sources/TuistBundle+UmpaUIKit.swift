...
/// Since UmpaUIKit is a static framework, the bundle containing the resources is copied into the final product.
static let module: Bundle = {
    let bundleName = "UmpaUIKit_UmpaUIKit"
    var candidates = [
    ...
    fatalError("unable to find bundle named UmpaUIKit_UmpaUIKit")
}()
}// MARK: - Objective-C Bundle Accessor
@objc
public class UmpaUIKitResources: NSObject {
